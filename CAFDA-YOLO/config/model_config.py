...
TRAIN = {
    ...
    'TRAIN_IMG_SIZE':256,  # training image size
    'BATCH_SIZE': 16,  # training batch size
    'IOU_THRESHOLD_LOSS': 0.5,  
    'YOLO_EPOCHS': 200,  # total training epochs
...
Customer_DATA = {
    ...
    'CLASSES': ['bss'],  # your dataset class
}
