...
def SDSS_photo_download_process(
    ...
    for url in urls:
        ...
        if os.path.exists(os.path.join(save_dir, '{}_{}_{}_{}_{}/{}'.format(unique_id, rerun, run, camcol, field,
            ...
            try:
                os.system('wget {} -T 200 -c -O {}'.format(url, os.path.join(save_dir, '{}_{}_{}_{}_{}/{}'.format(
...
def DECaLS_photo_download_process(
    ...
    bands = ''.join(bands)
    fits_base_url = \
        f'https://www.legacysurvey.org/viewer/fits-cutout?ra={ra}&dec={dec}&layer={layer}&pixscale={pixscale}&bands={bands}'
    jpg_base_url = \
        f'https://www.legacysurvey.org/viewer/jpeg-cutout?ra={ra}&dec={dec}&layer={layer}&pixscale={pixscale}'
    ...
    fits_filename = '{line}.fits'.format(line=line)
    jpg_filename = '{line}.jpg'.format(line=line)
